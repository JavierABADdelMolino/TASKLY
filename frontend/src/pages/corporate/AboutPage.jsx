          ...
          <div className="col-md-4 mb-4">
            <div className="card h-100 border-0 shadow-sm">
              <div className="card-body text-center p-4">
                <div style={{backgroundColor: "rgba(var(--bs-primary-rgb), 0.1)", color: "var(--bs-primary)", width: "80px", height: "80px"}} className="fs-1 mb-3 p-3 rounded-circle mx-auto d-flex align-items-center justify-content-center">
